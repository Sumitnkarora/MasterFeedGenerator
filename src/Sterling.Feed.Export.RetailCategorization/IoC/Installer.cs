...
using Sterling.Feed.Export.RetailCategorization.Services;
using System.IO;
    ...
    internal class Installer : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            ...
            container.AddFacility<LoggingFacility>(f => f.UseLog4Net("Log4net.config"))
                ...
                .Register(Component.For<IDataService>().ImplementedBy<RetailCategorizationService>().LifestyleSingleton())
