...
using Sterling.Feed.Export.StoreInformation.Services;
using System.IO;
using System.Reflection;

namespace Sterling.Feed.Export.StoreInformation.IoC
{
    internal class Installer : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            ...
            container.AddFacility<LoggingFacility>(f => f.UseLog4Net("Config\\Log4net.config"))
                ...
                .Register(Component.For<IDataService>().ImplementedBy<StoreInfoDataService>().LifestyleSingleton())
